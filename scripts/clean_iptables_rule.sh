...
iptables -t mangle -D OUTPUT -p udp -j SHADOWSOCKS_UDP_MARK 2> /dev/null
iptables -t mangle -F SHADOWSOCKS_UDP 2> /dev/null
iptables -t mangle -X SHADOWSOCKS_UDP 2> /dev/null
iptables -t mangle -F SHADOWSOCKS_UDP_MARK 2> /dev/null
iptables -t mangle -X SHADOWSOCKS_UDP_MARK 2> /dev/null
